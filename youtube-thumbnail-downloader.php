...
<main>
    <section class="bg-gradient-to-b from-teal-100 to-teal-50 py-16"> <?php /* Changed color theme slightly */ ?>
        <div class="container mx-auto px-6 text-center">
            <div class="bg-white p-8 md:p-12 rounded-xl shadow-xl max-w-3xl mx-auto">
                <h1 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4"><?php echo _t('yt_thumb_title', 'YouTube Thumbnail Downloader'); ?></h1>
                <p class="text-slate-600 mb-8"><?php echo _t('yt_thumb_description', 'Download thumbnails from YouTube videos in various resolutions.'); ?></p>
                <?php
    ...
    <section id="thumbnail-results" class="py-12">
        <div class="container mx-auto px-6">
            <h2 class="text-2xl font-bold text-slate-800 text-center mb-8"><?php echo _t('available_thumbnails_title', 'Available Thumbnails'); ?> (ID: <?php echo htmlspecialchars($video_id); ?>)</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <?php foreach ($thumbnail_urls as $index => $thumb): ?>
                    <div class="bg-white p-4 rounded-lg shadow-lg text-center">
                        <h3 class="text-lg font-semibold text-slate-700 mb-2"><?php echo htmlspecialchars($thumb['label']); ?></h3>
