...
?>
<main>
<section class="bg-gradient-to-b from-sky-100 to-slate-50 py-16">
<div class="container mx-auto px-6 text-center">
<div class="bg-white p-8 md:p-12 rounded-xl shadow-xl max-w-3xl mx-auto">
<h1 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">YouTube Video Downloader</h1>
<p class="text-slate-600 mb-8">Download YouTube videos to mp3 and mp4 online for free.</p>
<?php
...
<p class="text-slate-700 text-center max-w-3xl mx-auto mb-12">
...
<div class="container mx-auto px-6">
<h2 class="text-3xl font-bold text-slate-800 text-center mb-4">The Best Free Online Youtube Downloader</h2>
<p class="text-slate-700 text-center max-w-3xl mx-auto mb-12">
...
<h3 class="text-2xl font-semibold text-slate-800 text-center mb-8">How to download Youtube videos online via YTiD</h3>
<ol class="list-decimal list-inside space-y-4 max-w-xl mx-auto text-slate-700">
...
<section class="py-16">
<div class="container mx-auto px-6">
<h3 class="text-2xl font-semibold text-slate-800 text-center mb-8">How to Use YTiD downloader Short Domain?</h3>
...
<h4 class="font-semibold text-slate-800 mb-2">Open Youtube URL</h4>
<p class="text-slate-600">Open the target video in YouTube that you want to download.</p>
</div>
<div class="bg-white p-6 rounded-lg shadow-lg">
<h4 class="font-semibold text-slate-800 mb-2">Add "yd" before the video URL</h4>
<p class="text-slate-600">Add "yd" before the video URL to start the downloading process.</p>
</div>
<div class="bg-white p-6 rounded-lg shadow-lg">
<h4 class="font-semibold text-slate-800 mb-2">YT to MP4 will launch quickly</h4>
<p class="text-slate-600">After pressing the "Enter" button, you will be redirected to the page with several downloading options.</p>
</div>
</div>
</div>
</section>
